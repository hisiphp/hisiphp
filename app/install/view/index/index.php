...
<div class="install-box">
    <fieldset class="layui-elem-field site-demo-button">
        ...
        <div class="protocol">
            ...
            您可以在协议规定的约束和限制范围内修改HisiPHP产品源代码(如果被提供的话)或界面风格以适应您的网站要求。</br>
            您拥有使用本软件构建的网站中全部会员资料、文章及相关信息的所有权，并独立承担与使用本软件构建的网站内容的
            审核、注意义务，确保其不侵犯任何人的合法权益，独立承担因使用HisiPHP软件和服务带来的全部责任，若造成HisiPHP公司或
            用户损失的，您应予以全部赔偿。 </br>
            若您需将HisiPHP的软件或服务用于商业用途，必须另行获得HisiPHP的书面许可，您在获得商业授权之后，您可以将本软件应用于
            ...
            II. 协议规定的约束和限制 </br></br>
            未获HisiPHP公司书面商业授权之前，不得将本软件用于商业用途（包括但不限于企业网站、经营性网站、以营利为目或实现盈利
            的网站）。购买商业授权请访问http://www.hisiphp.com参考相关说明了解详情。</br>
            禁止去除HisiPHP源码里的版权信息，商业授权版本可去除后台界面及前台界面的相关版权信息。</br>
            禁止在HisiPHP整体或任何部分基础上发展任何派生版本、修改版本或第三方版本用于重新分发。
            </p>
        </div>
    </fieldset>
    <div class="step-btns">
