...
VALUES
  ...
  (51,0,'base','手机网站域名','wap_domain','ms.hisiphp.cn','input','','','手机访问将自动跳转至此域名',2,1,1504304776,1504304837),
...
VALUES
  ...
  (2,0,0,'admin','系统','','admin/system','','_self',1,0,1,1,1,1490315067),
  (3,0,0,'admin','插件','aicon ai-shezhi','admin/plugins','','_self',2,0,1,1,1,1490315067),
  ...
  (113,0,4,'admin','设置主题','','admin/user/setTheme','','_self',100,0,1,0,1,1490315067),
  (114, 0, 8, 'admin', '应用市场', 'aicon ai-app-store', 'admin/store/index', '', '_self', 0, 0, 1, 1, 1, 1490315067),
  (115, 0, 114, 'admin', '安装应用', '', 'admin/store/install', '', '_self', 100, 0, 1, 0, 1, 1490315067),
