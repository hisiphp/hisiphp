...
class Http {
     ...
     * @return string
     */
    public static function getRequest($url, $data = [], $header = [], $charset = 'UTF-8', $proxy = null, $expire = 30) {
        if (!$url) {
            return false;
        }
        if (!is_array($data)) {
     ...
     * @return string
     */
    public static function postRequest($url, $data = [], $header = [], $charset= 'UTF-8', $proxy = null, $expire = 30) {
        if (!$url) {
            return false;
        }
        //cookie file
