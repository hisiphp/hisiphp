<div class="layui-form">
    <table class="layui-table mt10" lay-even="" lay-skin="row">
        ...
        <tbody>
            {volist name="data_list" id="vo" empty="<tr><td colspan='5' align='center' height='100'>未发现相关模块，快去<a href='http://www.hisiphp.com' target='_blank'> <strong style='color:#428bca'>应用市场</strong> </a>看看吧！</td></tr>"}
            <tr>
                <td>
